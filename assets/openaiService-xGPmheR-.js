import{r as g,j as t}from"./index-CYkD4_p8.js";function te({show:e=!1,title:r="준비 중입니다…",message:i="조금만 기다려 주세요.",respectReducedMotion:o=!0,forceHaptics:s=!1}){const p=typeof navigator<"u"&&typeof navigator.vibrate=="function",[d,u]=g.useState(!1);g.useEffect(()=>{if(o)try{const n=window.matchMedia("(prefers-reduced-motion: reduce)"),x=()=>u(!!n.matches);return x(),n.addEventListener?n.addEventListener("change",x):n.addListener(x),()=>{n.removeEventListener?n.removeEventListener("change",x):n.removeListener(x)}}catch{}},[o]);const v=g.useMemo(()=>{try{return s||(navigator==null?void 0:navigator.maxTouchPoints)>0||window.matchMedia&&window.matchMedia("(hover: none) and (pointer: coarse)").matches}catch{return!!s}},[s]),[c,l]=g.useState(!1),a=()=>{try{const n=navigator.userActivation;return!!(n!=null&&n.isActive||n!=null&&n.hasBeenActive)}catch{return!1}};g.useEffect(()=>{e&&a()&&queueMicrotask(()=>l(!0))},[e]),g.useEffect(()=>{if(!e||c)return;const n=()=>{l(!0)};return window.addEventListener("pointerdown",n,{capture:!0,passive:!0}),window.addEventListener("keydown",n,{capture:!0}),window.addEventListener("touchstart",n,{capture:!0,passive:!0}),()=>{window.removeEventListener("pointerdown",n,{capture:!0}),window.removeEventListener("keydown",n,{capture:!0}),window.removeEventListener("touchstart",n,{capture:!0})}},[e,c]);const h=g.useRef(null),m=g.useRef(e),f=(n=20)=>{if(!p||!c&&!a()||d&&!s)return!1;try{return navigator.vibrate(n)?!0:Array.isArray(n)?navigator.vibrate(20)||!1:navigator.vibrate([20,30,20])||!1}catch{return!1}},j=()=>{if(h.current&&(clearInterval(h.current),h.current=null),p&&(c||a())&&!(d&&!s))try{navigator.vibrate(0)}catch{}};return g.useEffect(()=>(e&&v&&p&&(c||a())&&!(d&&!s)?(f(20),h.current||(h.current=setInterval(()=>{f(20)},2e3))):j(),m.current&&!e&&(f(0),setTimeout(()=>f([25,35,25]),0)),m.current=e,()=>{j()}),[e,v,p,c,d,s]),g.useEffect(()=>{if(!e)return;const n=()=>{document.visibilityState==="hidden"?j():e&&(c||a())&&(f(20),h.current||(h.current=setInterval(()=>f(20),2e3)))};return document.addEventListener("visibilitychange",n),()=>document.removeEventListener("visibilitychange",n)},[e,c]),g.useEffect(()=>{e&&(p||console.info("[FullScreenLoader] 이 환경은 navigator.vibrate를 지원하지 않습니다(iOS Safari 등)."))},[e,p]),e?t.jsxs("div",{role:"status","aria-live":"polite",className:`fs-loader ${d?"reduce":"animate"}`,children:[t.jsxs("div",{className:"fs-loader__inner",children:[t.jsxs("div",{className:"solarsys",role:"img","aria-label":"로딩 중: 태양계 애니메이션",children:[t.jsx("div",{className:"sun","aria-hidden":"true"}),t.jsx("div",{className:"orbit orbit--1","aria-hidden":"true",children:t.jsx("div",{className:"planet planet--1"})}),t.jsx("div",{className:"orbit orbit--2","aria-hidden":"true",children:t.jsx("div",{className:"planet planet--2"})}),t.jsx("div",{className:"orbit orbit--3","aria-hidden":"true",children:t.jsx("div",{className:"planet planet--3"})})]}),t.jsx("h3",{className:"fs-loader__title",children:r}),t.jsx("p",{className:"fs-loader__msg",children:i}),t.jsx("span",{style:{marginTop:2,fontSize:11,opacity:.45,userSelect:"none",display:"block"},children:p?c||a()?"진동 활성화됨":"화면을 한 번 터치하면 진동이 켜집니다":"이 기기는 진동 미지원"})]}),t.jsx("style",{children:`
...
`).split(/\n{2,}/).map(a=>`<p>${k(y(a))}</p>`);o+=`<blockquote>${l.join("")}</blockquote>`;continue}if(/^\s*\d+\.\s+/.test(d)){const c=s(l=>/^\s*\d+\.\s+/.test(l)).map(l=>l.replace(/^\s*\d+\.\s+/,"")).map(l=>`<li>${k(y(l))}</li>`).join("");o+=`<ol>${c}</ol>`;continue}if(/^\s*([-*•])\s+/.test(d)){const c=s(l=>/^\s*([-*•])\s+/.test(l)).map(l=>l.replace(/^\s*([-*•])\s+/,"")).map(l=>`<li>${k(y(l))}</li>`).join("");o+=`<ul>${c}</ul>`;continue}const v=[];for(;i<r.length&&!/^\s*$/.test(r[i]);)v.push(r[i++]);for(p(v);i<r.length&&/^\s*$/.test(r[i]);)i++}return o}const G=()=>t.jsxs("div",{className:"ai-loading",role:"img","aria-label":"로딩 중",children:[t.jsxs("svg",{className:"ai-spinner",width:"96",height:"96",viewBox:"0 0 96 96",xmlns:"http://www.w3.org/2000/svg",children:[t.jsx("defs",{children:t.jsxs("linearGradient",{id:"aiGrad",x1:"0",y1:"0",x2:"1",y2:"1",children:[t.jsx("stop",{offset:"0%",stopColor:"#0a84ff"}),t.jsx("stop",{offset:"50%",stopColor:"#7a5af8"}),t.jsx("stop",{offset:"100%",stopColor:"#0fa958"})]})}),t.jsx("circle",{cx:"48",cy:"48",r:"32",fill:"none",stroke:"url(#aiGrad)",strokeWidth:"4",strokeLinecap:"round",strokeDasharray:"160 60",children:t.jsx("animate",{attributeName:"stroke-dashoffset",from:"0",to:"-440",dur:"1.2s",repeatCount:"indefinite"})}),t.jsx("circle",{cx:"48",cy:"48",r:"24",fill:"none",stroke:"rgba(0,0,0,.08)",strokeWidth:"2",strokeDasharray:"4 6",children:t.jsx("animateTransform",{attributeName:"transform",type:"rotate",from:"0 48 48",to:"360 48 48",dur:"6s",repeatCount:"indefinite"})}),t.jsx("g",{transform:"translate(48,48)",children:t.jsxs("circle",{cx:"0",cy:"-24",r:"3.2",fill:"rgba(10,132,255,.85)",children:[t.jsx("animateTransform",{attributeName:"transform",type:"rotate",from:"0",to:"360",dur:"1.6s",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"r",values:"3.2;5;3.2",dur:"1.6s",repeatCount:"indefinite"})]})}),t.jsx("g",{transform:"translate(48,48)",children:t.jsxs("circle",{cx:"0",cy:"18",r:"2.8",fill:"rgba(122,90,248,.9)",children:[t.jsx("animateTransform",{attributeName:"transform",type:"rotate",from:"360",to:"0",dur:"2.4s",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"r",values:"2.8;4;2.8",dur:"2.4s",repeatCount:"indefinite"})]})})]}),t.jsx("style",{children:`
    ...
    `})]}),re=({content:e,isLoading:r,error:i})=>{if(r)return t.jsxs("div",{className:"ai-fortune",children:[t.jsxs("div",{className:"content",children:[t.jsx(G,{}),t.jsx("p",{"aria-live":"polite",children:"AI가 내용을 준비하는 중…"})]}),t.jsx("style",{children:`
        ...
        `})]});if(!e)return null;const o=B(e),s={"@context":"https://schema.org","@type":"Article",headline:"AI 사주 풀이",author:{"@type":"Person",name:"AI Fortune"},datePublished:new Date().toISOString(),articleSection:"Horoscope",inLanguage:"ko"};return t.jsxs("div",{className:"ai-fortune",children:[t.jsxs("article",{className:"content",itemScope:!0,itemType:"https://schema.org/Article",children:[t.jsx("div",{itemProp:"articleBody",dangerouslySetInnerHTML:{__html:o}}),t.jsx("meta",{itemProp:"author",content:"AI Fortune"})]}),t.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(s)}}),t.jsx("style",{children:`
        .ai-fortune .content {
      ...
      `})]})},C=typeof navigator<"u"&&typeof navigator.vibrate=="function";function M(){try{const e=navigator.userActivation;return!!(e!=null&&e.isActive||e!=null&&e.hasBeenActive)}catch{return!1}}function _(e=20){if(!C||!M())return!1;try{return navigator.vibrate(e)?!0:Array.isArray(e)?navigator.vibrate(20)||!1:navigator.vibrate([20,35,20])||!1}catch{return!1}}function R(){if(C&&M())try{navigator.vibrate(0)}catch{}}function J(){_(20)}function $(){R(),_(30)}function O(){R(),_([25,40,25])}const D=!1,V="https://cool-shape-9570.idcode1690.workers.dev",W=typeof location<"u"&&/github\.io|workers\.dev|vercel\.app|netlify\.app|unse\.news/i.test(location.host),A=D&&!W?"/api/ai":`${V}/chat`;try{console.info("[openaiService] endpoint:",A,"mode=","production","dev=",D)}catch{}const P="ai_cache_v1:",S=new Map,E=60*1e3,F=60*E,w=24*F;function U(){return Date.now()+9*F}function H(){const e=U(),r=w-e%w;return r>0?r:E}function Y(){const e=U(),i=new Date(e).getUTCDay(),o=e-e%w,s=(7-i)%7,d=o+(s===0?7:s)*w-e;return d>0?d:E}function q(e){const r=String(e||"").toUpperCase();return r.includes("TODAY")?H():r.includes("SAJU")?365*w:r.includes("COMPAT")?30*w:r.includes("LOTTO")?Y():30*w}function Z(e){try{return localStorage.getItem(e)}catch{return null}}function X(e,r){try{localStorage.setItem(e,r)}catch{}}function z(e){try{localStorage.removeItem(e)}catch{}}function Q(e){if(!e)return null;const r=P+e,i=Z(r);if(!i)return null;try{const{value:o,expireAt:s}=JSON.parse(i);return s&&Date.now()<s?String(o??""):(z(r),null)}catch{return z(r),null}}function K(e,r,i){if(!e)return;const o=P+e,s=Date.now()+(i??q(e));X(o,JSON.stringify({value:String(r??""),expireAt:s}))}async function ne({messages:e,cacheKey:r,model:i="gpt-5.1-mini",temperature:o=.1,top_p:s=1,max_tokens:p=1800,seed:d=777}={}){const u=r?Q(r):null;if(u!=null&&u!==""){try{console.debug("[openaiService] cache HIT:",r)}catch{}return u}if(r&&S.has(r)){try{console.debug("[openaiService] inflight dedupe:",r)}catch{}return S.get(r)}const v={model:i,messages:e,cacheKey:r,temperature:o,top_p:s,max_tokens:p,seed:d},c=async a=>{var x,I,T,L;const h=await fetch(a,{method:"POST",mode:"cors",credentials:"omit",cache:"no-store",headers:{"content-type":"text/plain;charset=UTF-8"},body:JSON.stringify(v),redirect:"follow",referrerPolicy:"no-referrer"}),m=await h.text();if(!h.ok){let b;try{b=JSON.parse(m)}catch{b={error:m}}const N=((x=b==null?void 0:b.error)==null?void 0:x.message)||(b==null?void 0:b.error)||m||"Unknown error";throw new Error(`OpenAI API 오류 (${h.status}): ${typeof N=="string"?N:JSON.stringify(N)}`)}let f;try{f=JSON.parse(m)}catch{f=null}const j=((L=(T=(I=f==null?void 0:f.choices)==null?void 0:I[0])==null?void 0:T.message)==null?void 0:L.content)??(f?"":m),n=String(j??"");return r&&n&&K(r,n,q(r)),n};try{J()}catch{}const l=(async()=>{try{const a=await c(A);try{$()}catch{}return a}catch(a){if(((a==null?void 0:a.name)==="TypeError"||/Failed to fetch/i.test(String((a==null?void 0:a.message)||"")))&&A!=="/api/ai")try{console.warn("[openaiService] primary failed, fallback -> /api/ai",a);const m=await c("/api/ai");try{$()}catch{}return m}catch(m){try{O()}catch{}throw m}try{O()}catch{}throw a}})();r&&S.set(r,l);try{return await l}finally{r&&S.delete(r)}}export{re as A,te as F,ne as c};
